...
export const zh = {
  ...
  'message.annotations.one': '{count} 条注释',
  'message.annotations.other': '{count} 条注释',
  'message.annotations.expand': '查看 {count} 条注释',
  'message.annotations.selectedText': '所选文本：',
  ...
  'message.turnProcess.contexts.one': '{count} 条上下文',
  'message.turnProcess.contexts.other': '{count} 条上下文',
...
export const en = {
  ...
  'message.referenceSeparator': ', ',
  'message.annotations.one': '{count} annotation',
  'message.annotations.other': '{count} annotations',
  'message.annotations.expand': 'View {count} annotations',
  'message.annotations.selectedText': 'Selected text:',
  ...
  'message.turnProcess.contexts.one': '{count} context entry',
  'message.turnProcess.contexts.other': '{count} context entries',
