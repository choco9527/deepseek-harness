...
The Settings dialog and backdrop enter over 180ms and leave over 100ms. Closing immediately restores trigger focus and disables dialog interaction; reopening cancels pending removal. Reduced-motion preferences disable animation and remove the dialog immediately.
